...
* A typical command to train on CIFAR100 would be:python main_memo.py --dataset cifar100 --convnet_type memo_resnet32 --init_cls 50 --increment 10 --memory_size 3312 --batch_size 128 --init_epoch 200 --epochs 200
